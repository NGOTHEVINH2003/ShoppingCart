	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		String htmlTextMessage = "" + "<html>" + "<body>"
				...
				+ "Fans Message Received !!<br/><br/> Name: " + name + "," + "<br/><br/> Email Id: " + email
                                + "<br><br/> Type of Contact: " + typeContact + ","+ "<br/><br/>PhoneNumber:" + phoneNumber
				...
				+ "</body>" + "</html>";
		String message = MailMessage.sendMessage("vinhnthe170433@fpt.edu.vn", "Fans Message | " + name + " | " + email,
				htmlTextMessage);
