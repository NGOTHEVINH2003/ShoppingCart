            ...
            <div class="container" style="background-color: #E6F9E6;">
                <div class="row text-center">
                    ...
                    <div class="col-sm-4" style='height: 350px;'>
                        <div class="thumbnail">
                            <img src="./ShowImage?pid=<%=product.getProdId()%>" alt="ProductF"
                            ...
                            <form method="post">
                                <% if (product.isActive()) {%>
                                <button type="submit"
                                        formaction="./RemoveProductSrv?prodid=<%=product.getProdId()%>&isActive=false"
                                ...
                                %>    
                                <button type="submit"
                                        formaction="./RemoveProductSrv?prodid=<%=product.getProdId()%>&isActive=true"
